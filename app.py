...
dict= {1:'ASIA (EX. NEAR EAST)','BALTICS':2,'C.W. OF IND. STATES':3,'EASTERN EUROPE':4,'LATIN AMER. & CARIB':5,'NEAR EAST':6,'NORTHERN AFRICA':7,'NORTHERN AMERICA':8,'OCEANIA':9,'SUB-SAHARAN AFRICA':10,'WESTERN EUROPE':11}
...
if st.button('Estimate GDP'):
    ...
    p = int(gbm_predictions)
    st.write('The estimated GDP per capita is: ', p)
